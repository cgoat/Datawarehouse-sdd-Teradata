"""Column ordering for the 25 TPC-DS tables.

Pipe-delimited .dat files have no header; pandas needs the column names
in TPC-DS canonical order. Types live in teradata/ddl/01_bronze_tables.sql.
"""
...
TABLES: dict[str, list[str]] = {
    ...
    "store": [
        ...
        "s_street_number", "s_street_name", "s_street_type", "s_suite_number", "s_city",
        "s_county", "s_state", "s_zip", "s_country", "s_gmt_offset", "s_tax_precentage",
    ],
    "store_returns": [
